...
- (void) setup {
    ...
    labelH = 20;
    toTopSpace = 10;
    labelW = SCREEN_WIDTH/4-2*spaceToLeft;
    ...
    NSArray *views = @[ _medicinalNameLabel, _medicinalTypeLabel, _oneLineView, _medicinalTypeNumLabel, _medicinalTimeLabel, _staticOtherNameLabel, _otherNameLabel, _twoLineView, _staticDisclaimerLabel, _disclaimerLabel];
...
- (void) setModel:(RiskTypeDetailLeftModel *)model {
    
    _medicinalNameLabel.text = model.medicinalNameString;
    _medicinalTypeLabel.text = model.medicinalTypeString;
    
    UIColor *medicinalTypeNumLabelColor = EF_TextColor_TextColorPrimary;
    NSMutableAttributedString *medicinalTypeNumString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"分类编号: %@",model.medicinalTypeNumString]];
    ...
    NSMutableAttributedString *medicinalTimeString = [[NSMutableAttributedString alloc] initWithString:[NSString stringWithFormat:@"更新时间: %@",model.medicinalTimeString]];
    ...
    _otherNameLabel.text = model.otherNameString;

    _staticDisclaimerLabel.text = @"免责声明: ";
    _disclaimerLabel.text = model.disclaimerString;
