...
#define SecondCollectionSmallToolCell @"SecondCollectionSmallToolCell"

@interface RSDataCenterVC ()<UITextFieldDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UIScrollViewDelegate>
...
//    [_backScrollView setContentSize:CGSizeMake(SCREEN_WIDTH*3, SCREEN_HEIGHT-64)];
...
//    
//    for (int i = 0; i < 9; i++) {
//        UIView * backView = [[UIView alloc]initWithFrame:CGRectMake(i*SCREEN_WIDTH/3, 0, SCREEN_WIDTH/3, SCREEN_HEIGHT-64)];
//        backView.backgroundColor = [UIColor whiteColor];
//        [self initSecondCollectionViewToView:backView indexPath:i];
//        
...
//    if (indexPath.row == 7) {
//        flowLayout.itemSize = CGSizeMake(SCREEN_WIDTH/6, SCREEN_WIDTH/6);
//    }else {
...
//    }
    ...
    _secondCollectionView.tag = indexPath.row+1000;
    NSLog(@"collection.tag--%d",(int)_secondCollectionView.tag);
...
//    }else {
//        [_secondCollectionView registerClass:[SecondSmallToolCell class] forCellWithReuseIdentifier:SecondCollectionSmallToolCell];
//    }
...
//        int i = (int)_secondCollectionView.tag-1000;
//        
//        if (i == 7) {
//            SecondSmallToolCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:SecondCollectionSmallToolCell forIndexPath:indexPath];
